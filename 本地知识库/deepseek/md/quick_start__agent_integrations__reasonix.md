...
#### 1. 安装 Node.js[​](#1-安装-nodejs "1. 安装 Node.js的直接链接")
...
#### 3. 进入项目目录，执行 `npx reasonix code` 即可开始使用。[​](#3-进入项目目录执行-npx-reasonix-code-即可开始使用 "3-进入项目目录执行-npx-reasonix-code-即可开始使用的直接链接")
