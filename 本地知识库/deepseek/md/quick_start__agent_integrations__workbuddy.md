...
#### 3. 重启并选择模型[​](#3-重启并选择模型 "3. 重启并选择模型的直接链接")
...
#### 4. 可选：验证 API Key[​](#4-可选验证-api-key "4. 可选：验证 API Key的直接链接")
