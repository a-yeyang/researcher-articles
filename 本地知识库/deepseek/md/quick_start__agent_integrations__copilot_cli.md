...
#### 1. 安装 GitHub Copilot CLI[​](#1-安装-github-copilot-cli "1. 安装 GitHub Copilot CLI的直接链接")
...
#### 2. 获取 DeepSeek API Key[​](#2-获取-deepseek-api-key "2. 获取 DeepSeek API Key的直接链接")
...
#### 4. 启动 Copilot CLI[​](#4-启动-copilot-cli "4. 启动 Copilot CLI的直接链接")
...
#### 可选：配置 Token 限制[​](#可选配置-token-限制 "可选：配置 Token 限制的直接链接")
