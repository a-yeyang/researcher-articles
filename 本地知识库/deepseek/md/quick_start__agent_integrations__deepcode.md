...
#### 1. 安装 Deep Code[​](#1-安装-deep-code "1. 安装 Deep Code的直接链接")
...
#### 2. 配置 Deep Code[​](#2-配置-deep-code "2. 配置 Deep Code的直接链接")
...
#### 3. 进入项目目录并启动 Deep Code[​](#3-进入项目目录并启动-deep-code "3. 进入项目目录并启动 Deep Code的直接链接")
...
#### 使用 Agent Skills[​](#使用-agent-skills "使用 Agent Skills的直接链接")
