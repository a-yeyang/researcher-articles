...
## 接入 Claude Code[​](#接入-claude-code "接入 Claude Code的直接链接")
...
## 接入 OpenClaw[​](#接入-openclaw "接入 OpenClaw的直接链接")

OpenClaw 是一个开源的个人 AI 助手，可以接入飞书、微信等常用聊天工具，可以通过 Skill 扩展能力。

#### 1. 安装 OpenClaw[​](#1-安装-openclaw "1. 安装 OpenClaw的直接链接")
...
#### 2. 配置 OpenClaw 中的默认模型[​](#2-配置-openclaw-中的默认模型 "2. 配置 OpenClaw 中的默认模型的直接链接")
