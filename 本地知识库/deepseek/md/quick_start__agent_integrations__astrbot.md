...
#### 1. 安装 AstrBot[​](#1-安装-astrbot "1. 安装 AstrBot的直接链接")

##### 通过 uv 安装 AstrBot[​](#通过-uv-安装-astrbot "通过 uv 安装 AstrBot的直接链接")
...
##### 通过 Docker 安装 AstrBot[​](#通过-docker-安装-astrbot "通过 Docker 安装 AstrBot的直接链接")
...
#### 2. 配置 AstrBot 中的默认模型[​](#2-配置-astrbot-中的默认模型 "2. 配置 AstrBot 中的默认模型的直接链接")
