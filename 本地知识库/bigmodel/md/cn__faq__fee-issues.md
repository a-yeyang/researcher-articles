...
**A：** Bigmodel 开放平台暂时不支持任意形式的退款功能，请您充分预估实际需求并确定充值金额，由于平台接口对 tokens 连续消耗的特性，消耗账户通常不支持退款。
...
**Q：平台的上 APIkey 删除后，还会扣钱吗？**

**A：** 如果 APIkey 被删除，则该 APIkey 将无法再次成功调用接口，也不会产生扣费。
