...
| :-: | :-----------------: | :------------------: | :-----------------------------------: | :--------: |
| 北京市 | 智谱清言<br />（ChatGLM） | 北京智谱华章<br />科技股份有限公司 |     Beijing-ChatGLM-<br />20230821    |  2023/8/31 |
...
<CardGroup cols={2}>
  ...
  <Card title="合规保障" icon={<svg style={{maskImage: "url(https://mintcdn.com/zhipu-ef7018ed/6jZAOYw-eXEZh1pv/resource/icon/shield.svg?fit=max&auto=format&n=6jZAOYw-eXEZh1pv&q=85&s=a40f70c5bd3e70524784b04dcd0fe669)", maskRepeat: "no-repeat", maskPosition: "center center",}} className={"h-6 w-6 bg-primary dark:bg-primary-light !m-0 shrink-0"}/>}>
    所有服务均经过严格审核，确保合规运营
  </Card>
</CardGroup>
