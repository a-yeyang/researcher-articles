...
<Frame>
  <img className="block dark:hidden" src="https://cdn.bigmodel.cn/static/logo/dark.svg" alt="智谱开放平台" />

  <img className="hidden dark:block" src="https://cdn.bigmodel.cn/static/logo/light.svg" alt="智谱开放平台" />
</Frame>
