...
| 参数名称              | 类型            | 是否必填 | 参数说明                                                       |
| :---------------- | :------------ | :--- | :--------------------------------------------------------- |
| agent\_id         | String        | 是    | 智能体 ID ：`subtitle_translation_agent`                       |
| messages          | List\<Object> | 是    | 会话消息体                                                      |
| └─ role           | String        | 是    | 用户的输入 `role = user`                                        |
| └─ content        | String        | 是    | 会话消息体                                                      |
| custom\_variables | Object        | 是    | 智能体扩展参数                                                    |
| └─ language       | String        | 是    | 目标语言，支持英文、日语、韩语，`English` 表示英文，`Japanese`表示日语，`Korean`表示韩语 |
